<template>
  <div class="table-style">
    ...
    <div v-else>
      {{data}}
      <alert-item :messages="errors" :title="'Oop!'"></alert-item>
    </div>
  </div>
</template>
  ...
  computed: {
    rows() {
      ...
      if (this.data.length) data = [...this.data];
        ...
        data = window.axios.get(this.api).then(resp => resp);
      } else {
        ...
        /* filter = [
          {
            ...
            amount: "4000.00",
            amount_currency: "NGN",
            created: "2020-05-21T19:09:29.008647+01:00",
            updated: "2020-05-21T19:09:29.008686+01:00"
          }
        ]; */
      }
