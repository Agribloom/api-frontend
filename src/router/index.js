	...
	},
	{
		...
		children: [
			...
			},
			{
				...
				component: () =>
					import(
						/* webpackChunkName: "account", webpackPrefetch: true */ "../pages/admin/DashboardPage.vue"
						),
			},
			{
				path: "users",
				...
				component: () =>
					import(
						/* webpackChunkName: "account", webpackPrefetch: true */ "../pages/admin/UserManagementPage.vue"
						),
			},
			{
				path: "transaction",
				...
				component: () =>
					import(
						/* webpackChunkName: "account",webpackPrefetch: true */ "../pages/admin/TransactionPage.vue"
						),
			},
			{
				path: "investment",
				...
				component: () =>
					import(
						/* webpackChunkName: "account",webpackPrefetch: true */ "../pages/admin/InvestmentPage.vue"
						),
			},
		]
	},
