                ...
                <form @submit.prevent="onSignIn" id="reset-form" method="post" novalidate="true">
                    <div :class="{'has-error': email.error}" class="form-group email-field">
                        <div class="input-group" ref="email-group">
                            ...
                            <input :pattern="email.validator" :placeholder="email.placeholder"
    ...
    export default {
        ...
        methods: {
            ...
            passwordFidelity() {
                ...
                if (!test) {
                    msg.push('Password must be no less than eight (8) characters. Special characters are allowed')
                }
                msg.forEach(value => {
            ...
            signIn() {
                ...
                Promise.resolve(this.serverFidelity()).then(status => {
                    if (status === 200) {
                        // If the status is 'OK'
